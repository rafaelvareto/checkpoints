...
__all__ = ['Senet50_ft_vggface2', 'senet50_ft_vggface2']
...
class Senet50_ft_vggface2(nn.Module):

    def __init__(self, block, layers, num_classes=8631, include_top=True):
        self.inplanes = 64
        super(Senet50_ft_vggface2, self).__init__()
...
def senet50_ft_vggface2(pretrained=False, progress=True, weights_path=None, **kwargs):
    """
    ...
    """
    arch = 'cydonia_senet50_vggface2'
    model = Senet50_ft_vggface2(block=Bottleneck, layers=[3, 4, 6, 3], **kwargs)
    if pretrained:
...
if __name__ == '__main__':
    model = senet50_ft_vggface2(pretrained=True, progress=True)